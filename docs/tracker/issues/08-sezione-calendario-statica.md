...
- [x] Gli eventi passati e i task suggeriti sono visualizzati in due blocchi distinti e riconoscibili
- [x] Il contenuto è mock/statico (dati identici o ispirati al prototipo)
- [x] I task suggeriti non sembrano "già approvati" — devono risultare chiaramente come proposte
